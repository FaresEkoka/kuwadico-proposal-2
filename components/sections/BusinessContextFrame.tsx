...
export default function BusinessContextFrame() {
  ...
  return (
    <Frame id="business-context" className="bg-dark">
      ...
      />
      <div className="h-full flex flex-col justify-center p-6 md:p-8 lg:p-10 max-w-6xl mx-auto relative z-10 overflow-hidden">
        <motion.div
        ...
        >
          ...
          {frame.points?.map((point, index) => (
            <motion.div
              ...
              className="flex items-start gap-2 text-sm md:text-base text-white/90 font-normal tracking-wide"
            >
